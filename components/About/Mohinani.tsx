        ...
        <div className="absolute inset-0 bg-gradient-to-r from-primary/90 to-primary/60 flex items-center">
          <div className="text-white px-8 md:px-16 space-y-4">
            ...
            <p className="text-xl md:text-2xl max-w-2xl">
              Building Tomorrow
              <span className="font-family-cera-stencil">'</span>s Africa, Today
            </p>
          </div>
        </div>
      </motion.div>
        ...
        <div className="absolute inset-0 bg-black/60 flex items-center justify-center">
          <div className="text-white px-8 text-center max-w-4xl space-y-4">
            <p className="text-xl md:text-3xl italic leading-relaxed">
              <span className="font-family-cera-stencil">"</span>Through common alignment on these values as an organization, we
              strengthen our foundation and grow with purpose<span className="font-family-cera-stencil">"</span>
            </p>
